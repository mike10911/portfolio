...
export const Homepage = () => {
  return (
    <div className="home">
      ...
      <a href="https://github.com/mike10911" target="_blank">
        <AiFillGithub size="3rem" />
      </a>
      <a href="https://www.linkedin.com/in/michael-mundia/" target="_blank">
        <AiFillLinkedin size="3rem" />
      </a>
      <a href="https://mikemundia.wordpress.com/" target="_blank">
        <BsCamera2 size="3rem" />
      </a>
    </div>
  );
